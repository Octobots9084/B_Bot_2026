...
public class CompConstants {
    ...
    public static final CANBus kCANBus = new CANBus("krakenbus", "./logs/example.hoot");
    ...
    public static SwerveSubsystem createDrivetrain() {
        return new SwerveSubsystem(
            ButtonConfig.driverController, ButtonConfig.coDriverController, Constants.maxVelocity, Constants.maxAngularVelocity);
    }
